var questions = [
    ...
    {
        title: "What was the original name of JavaScript?",
        choices: ["LiveScript", "JavaNet", "Java", "Scripting"],
        answer: "LiveScript"
    },
  ];
...
document.addEventListener('DOMContentLoaded', (event) => {
	...
	//FUNCTION changes the question and has a parameter to control the text which is provided whether it is correct or wrong
